...
function writeLog(projPath, projName) {
  try {
    ...
    console.log(colors.FgMagenta, "[~] Writing log file", colors.Reset);
    fs.writeFileSync(path.join(projPath, 'launchsettings.conf'), `
  <launchSettings>
  ...
  `, "utf8");
    ...
    console.warn('[!] - Writing Log file skipped')
  }
}
