...
function startLiveServer(){
  assetsServer.listen(PORT, () => {
    try {
      ...
      Starting live file server${colors.FgYellow}${ROOT}${colors.Reset}
...
reloadServer.on("listening", () => {
  console.log(`${colors.Dim}[WebSocket Server is running on port: ${WS_PORT}]${colors.Reset}`);
});
...
function checkForIndex(){
  ...
  if(!hasIndex) throw new Error('Missing index.html. cannot serve. \nAre you serving from the right file location?')
}
